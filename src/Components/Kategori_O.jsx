...
export default function Kategori_O() {
  return (
    <div>
      <figure className="relative h-full w-full mt-14">
        <img
          ...
          alt="nature image"
        />
        <figcaption className=" absolute bottom-52 left-2/4 flex h-52 w-[calc(100%-35rem)] -translate-x-2/4 justify-between rounded-xl border border-white bg-white/80 py-4 px-6 shadow-lg shadow-black/50 saturate-200 backdrop-blur-sm">
